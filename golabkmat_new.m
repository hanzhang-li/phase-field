    ...
    function [onetk,trhsk,oneph,trhsp]=golabkmat_new(element,totalstress,totalph,totalhm,tnijmart,tdetmart, ...
        ...
        for i=1:size(element,1)
            ...
            for j=1:4
              dcmat(3*(j-1)+(1:3),:)=Cmat(3*(elemnode2(j)-1)+(1:3),:);
            end
            
            % 计算单元劲度矩阵
            [delemk,rhsk,delemphi,rhsp]=elemart_new ...
