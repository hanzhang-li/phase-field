% 本程序用于更新力场以及相场计算值
function [totalph,totalstress,totaldisp,totalhm,loadforcest,pristress,pristrain]=renewresult_yh ...
    ...
    % 按照单元存储节点与单元坐标
    [dispx,dispy]=elemdispcoor(totaldisp,element);
    ...
    [~,totalstress]=avestressfunop(element,strain,stress,linknode,snode,nnode);
